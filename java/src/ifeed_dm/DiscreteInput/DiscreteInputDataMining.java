...
public abstract class DiscreteInputDataMining {
    ...
    protected List<DiscreteInputArchitecture> architectures;
    
    protected List<Integer> behavioral;
    protected List<Integer> non_behavioral;
    protected List<Integer> population;
    
    protected DiscreteInputCandidateFeatureGenerator candidateGenerator;
    
    
    public DiscreteInputDataMining(List<Integer> behavioral, List<Integer> non_behavioral, List<DiscreteInputArchitecture> architectures,
    ...
    public List<BaseFeature> evaluateBaseFeatures(List<DiscreteInputFilter> candidate_features){
        ...
        try {
            ...
            for(DiscreteInputFilter cand: candidate_features){
                ...
                for(DiscreteInputArchitecture a: this.architectures){
    ...
    public List<DiscreteInputArchitecture> getArchitectures(){return this.architectures;}
