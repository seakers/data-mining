...
public abstract class DataMining {
    ...
    public List<BinaryInputFeature> evaluateBaseFeatures(List<BinaryInputFilter> candidate_features){
    ...
    public List<BinaryInputFeature> adjustBaseFeatureSize(List<BinaryInputFeature> baseFeatures){
