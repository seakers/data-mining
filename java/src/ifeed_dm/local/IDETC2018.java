...
import ifeed_dm.EOSS.TypicalityCalculator;
import ifeed_dm.EOSS.filtersWithRepairOperator.*;
import ifeed_dm.FeatureExpressionHandler;
import ifeed_dm.FeatureFetcher;
import ifeed_dm.Filter;
import ifeed_dm.logic.*;
...
public class IDETC2018 {
    ...
    private static List<Literal> getSatisfiedLeafs(List<Literal> leafs, EOSSFeatureFetcher fetcher, BitSet inputs){
        ...
        for(Literal leaf: leafs){
            Filter filter = fetcher.fetchFilter(leaf.getName());
    ...
    private static RepairOperators fetchRepairOperator(String expression){
    ...
    private static RepairOperators fetchRepairOperator(String type, String[] args){
