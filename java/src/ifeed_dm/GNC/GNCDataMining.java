...
public class GNCDataMining extends DiscreteInputDataMining{
    
    BitSet labels;

    public GNCDataMining(List<Integer> behavioral, List<Integer> non_behavioral, List<DiscreteInputArchitecture> architectures, double supp, double conf, double lift) {
        super(behavioral, non_behavioral, architectures, supp, conf, lift); 
        
        super.candidateGenerator = new GNCFeatureGenerator();     
...
//            this.drivingFeatures = mRMR.minRedundancyMaxRelevance( population.size(), getDataMat(this.drivingFeatures), this.labels, this.drivingFeatures, topN);
        ...
        System.out.println("...[GNCDataMining] Total features found: " + extracted_features.size());
