...
public class EOSSMOEA {
    ...
    public static void main(String[] args) {
        ...
        FeatureFetcher featureFetcher = new EOSSFeatureFetcher(architectures);
        MOEABase base = new ifeed.problem.eoss.EOSSMOEA(architectures, behavioral, non_behavioral, featureFetcher);
        ...
        switch (MODE) {
            ...
            case 1: //Use epsilonMOEA
                ...
                for (int i = 0; i < numRuns; i++) {
                    Variation mutation  = new FeatureMutation(base);
                    Variation crossover = new FeatureCrossOver(base);
