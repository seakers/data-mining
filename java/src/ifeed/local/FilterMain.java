...
public class FilterMain {
    ...
    public static void main(String [] args) {
        ...
        List<AbstractArchitecture> data = registerData(labeledDataFile);
     ...
     */
    private static List<AbstractArchitecture> registerData(String labledDataFile) {

        List<AbstractArchitecture> data = new ArrayList<>();
