...
public class EOSSMOEA extends MOEABase implements AbstractDataMiningAlgorithm {
    ...
    public List<Feature> run(){
        ...
        MOEABase base = new ifeed.problem.eoss.EOSSMOEA(super.architectures, super.behavioral, super.non_behavioral);
...
//        properties.setBoolean("saveSelection", true);
        ...
        for(int i = 0; i < pop.size(); i++){
            ...
            Feature thisFeature = new Feature(root.getName(), root.getMatches(), metrics[0], metrics[1], metrics[2], metrics[3], Double.NaN);
            out.add(thisFeature);
        }
