 ...
 * @author bang
 */
public class Together extends ifeed.problem.assignment.filters.Together implements BinaryInputFilterOperator {
    ...
    public BitSet disrupt(BitSet input){
        ...
        if(!super.apply(input)){
            ...
            out.clear(randOrb * Params.num_instruments + randInstr);
            return out;
        }
    }
    ...
    public BitSet repair(BitSet input) {
        if(super.apply(input)){
            ...
            for(int i: super.instruments){
                out.set(o * Params.num_instruments + i);
            }
            return out;
        }
    }
