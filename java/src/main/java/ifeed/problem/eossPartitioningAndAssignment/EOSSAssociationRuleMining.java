...
public class EOSSAssociationRuleMining extends AssociationRuleMining {

    public EOSSAssociationRuleMining(List<AbstractArchitecture> architectures, List<Integer> behavioral, List<Integer> non_behavioral, double supp, double conf, double lift) {
