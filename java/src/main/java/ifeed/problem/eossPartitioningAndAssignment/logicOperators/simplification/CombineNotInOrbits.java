package ifeed.problem.eossPartitioningAndAssignment.logicOperators.simplification;
...
public class CombineNotInOrbits extends AbstractSimplificationOperator{
    ...
    protected void apply(Connective root,
        ...
        Filter notInOrbitFilter = new NotInOrbit(selectedArgument, combinedInstrumentsArray);
