...
import ifeed.mining.arm.AssociationRuleMining;
...
public class GNCAssociationRuleMining extends AssociationRuleMining {

    public GNCAssociationRuleMining(List<AbstractArchitecture> architectures, List<Integer> behavioral, List<Integer> non_behavioral,
...
//        System.out.println("...[GNCAssociationRuleMining] Total features found: " + minedFeatures.size() + ", Pareto front: " + extracted_features.size());
//        System.out.println("...[GNCAssociationRuleMining] Total data mining time : " + String.valueOf(t1 - t0) + " msec");
//
...
//        System.out.println("...[GNCAssociationRuleMining] Local Search root feature name: " + feature.getName());
//
...
//        long t1 = System.currentTimeMillis();
//
//        System.out.println("...[GNCAssociationRuleMining] Total features found: " + mined_features.size() + ", Pareto front: " + extracted_features.size());
//        System.out.println("...[GNCAssociationRuleMining] Total data mining time : " + String.valueOf(t1 - t0) + " msec");
//
//        return extracted_features;
//
