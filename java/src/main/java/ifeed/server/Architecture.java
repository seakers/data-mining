...
public class Architecture implements org.apache.thrift.TBase<Architecture, Architecture._Fields>, java.io.Serializable, Cloneable, Comparable<Architecture> {
  ...
  public Architecture setInputs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public Architecture setOutputs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> outputs) {
    this.outputs = outputs;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inputs = new java.util.ArrayList<java.lang.Double>(_list8.size);
                double _elem9;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputs = new java.util.ArrayList<java.lang.Double>(_list11.size);
                double _elem12;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Architecture struct) throws org.apache.thrift.TException {
      ...
      if (struct.inputs != null) {
        oprot.writeFieldBegin(INPUTS_FIELD_DESC);
        {
          ...
          for (double _iter14 : struct.inputs)
          {
      ...
      if (struct.isSetInputs()) {
        {
          ...
          for (double _iter16 : struct.inputs)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.inputs = new java.util.ArrayList<java.lang.Double>(_list18.size);
          double _elem19;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.outputs = new java.util.ArrayList<java.lang.Double>(_list21.size);
          double _elem22;
