...
public class ContinuousInputArchitecture implements org.apache.thrift.TBase<ContinuousInputArchitecture, ContinuousInputArchitecture._Fields>, java.io.Serializable, Cloneable, Comparable<ContinuousInputArchitecture> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ContinuousInputArchitecture");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ContinuousInputArchitectureStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ContinuousInputArchitectureTupleSchemeFactory();

  public int id; // required
  public java.util.List<Double> inputs; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ContinuousInputArchitecture.class, metaDataMap);
  }

  public ContinuousInputArchitecture() {
  }

  public ContinuousInputArchitecture(
    int id,
    java.util.List<Double> inputs,
   ...
   */
  public ContinuousInputArchitecture(ContinuousInputArchitecture other) {
    __isset_bitfield = other.__isset_bitfield;
    this.id = other.id;
    if (other.isSetInputs()) {
      java.util.List<Double> __this__inputs = new java.util.ArrayList<Double>(other.inputs);
  ...
  public ContinuousInputArchitecture deepCopy() {
    return new ContinuousInputArchitecture(this);
  }
  ...
  public ContinuousInputArchitecture setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Double> getInputsIterator() {
    return (this.inputs == null) ? null : this.inputs.iterator();
  }

  public void addToInputs(double elem) {
    if (this.inputs == null) {
      this.inputs = new java.util.ArrayList<Double>();
    }
  ...
  public ContinuousInputArchitecture setInputs(java.util.List<Double> inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public ContinuousInputArchitecture setOutputs(java.util.List<Double> outputs) {
    this.outputs = outputs;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INPUTS:
      if (value == null) {
        ...
        setInputs((java.util.List<Double>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ContinuousInputArchitecture)
      return this.equals((ContinuousInputArchitecture)that);
    return false;
  }

  public boolean equals(ContinuousInputArchitecture that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ContinuousInputArchitecture other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ContinuousInputArchitecture(");
    boolean first = true;
  ...
  private static class ContinuousInputArchitectureStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ContinuousInputArchitectureStandardScheme getScheme() {
      return new ContinuousInputArchitectureStandardScheme();
    }
  }

  private static class ContinuousInputArchitectureStandardScheme extends org.apache.thrift.scheme.StandardScheme<ContinuousInputArchitecture> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ContinuousInputArchitecture struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inputs = new java.util.ArrayList<Double>(_list40.size);
                double _elem41;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputs = new java.util.ArrayList<Double>(_list43.size);
                double _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = iprot.readDouble();
                  struct.outputs.add(_elem44);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ContinuousInputArchitecture struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.inputs != null) {
        oprot.writeFieldBegin(INPUTS_FIELD_DESC);
        {
          ...
          for (double _iter46 : struct.inputs)
          {
      ...
      if (struct.outputs != null) {
        oprot.writeFieldBegin(OUTPUTS_FIELD_DESC);
        {
          ...
          for (double _iter47 : struct.outputs)
          {
  ...
  private static class ContinuousInputArchitectureTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ContinuousInputArchitectureTupleScheme getScheme() {
      return new ContinuousInputArchitectureTupleScheme();
    }
  }

  private static class ContinuousInputArchitectureTupleScheme extends org.apache.thrift.scheme.TupleScheme<ContinuousInputArchitecture> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ContinuousInputArchitecture struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInputs()) {
        {
          ...
          for (double _iter48 : struct.inputs)
          {
      ...
      if (struct.isSetOutputs()) {
        {
          ...
          for (double _iter49 : struct.outputs)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ContinuousInputArchitecture struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.inputs = new java.util.ArrayList<Double>(_list50.size);
          double _elem51;
          for (int _i52 = 0; _i52 < _list50.size; ++_i52)
          {
            _elem51 = iprot.readDouble();
            struct.inputs.add(_elem51);
          }
        }
        struct.setInputsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.outputs = new java.util.ArrayList<Double>(_list53.size);
          double _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = iprot.readDouble();
            struct.outputs.add(_elem54);
          }
        }
        struct.setOutputsIsSet(true);
      }
