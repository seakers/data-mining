...
public class PartitioningAndAssigningProblemParameters implements org.apache.thrift.TBase<PartitioningAndAssigningProblemParameters, PartitioningAndAssigningProblemParameters._Fields>, java.io.Serializable, Cloneable, Comparable<PartitioningAndAssigningProblemParameters> {
  ...
  public PartitioningAndAssigningProblemParameters setOrbitList(java.util.List<String> orbitList) {
    this.orbitList = orbitList;
    return this;
  }
  ...
  public PartitioningAndAssigningProblemParameters setInstrumentList(java.util.List<String> instrumentList) {
    this.instrumentList = instrumentList;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartitioningAndAssigningProblemParameters(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orbitList = new java.util.ArrayList<String>(_list88.size);
                String _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = iprot.readString();
                  struct.orbitList.add(_elem89);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instrumentList = new java.util.ArrayList<String>(_list91.size);
                String _elem92;
                for (int _i93 = 0; _i93 < _list91.size; ++_i93)
                {
                  _elem92 = iprot.readString();
                  struct.instrumentList.add(_elem92);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitioningAndAssigningProblemParameters struct) throws org.apache.thrift.TException {
      ...
      if (struct.orbitList != null) {
        oprot.writeFieldBegin(ORBIT_LIST_FIELD_DESC);
        {
          ...
          for (String _iter94 : struct.orbitList)
          {
      ...
      if (struct.instrumentList != null) {
        oprot.writeFieldBegin(INSTRUMENT_LIST_FIELD_DESC);
        {
          ...
          for (String _iter95 : struct.instrumentList)
          {
      ...
      if (struct.isSetOrbitList()) {
        {
          ...
          for (String _iter96 : struct.orbitList)
          {
      ...
      if (struct.isSetInstrumentList()) {
        {
          ...
          for (String _iter97 : struct.instrumentList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.orbitList = new java.util.ArrayList<String>(_list98.size);
          String _elem99;
          for (int _i100 = 0; _i100 < _list98.size; ++_i100)
          {
            _elem99 = iprot.readString();
            struct.orbitList.add(_elem99);
          }
        }
        struct.setOrbitListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.instrumentList = new java.util.ArrayList<String>(_list101.size);
          String _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = iprot.readString();
            struct.instrumentList.add(_elem102);
          }
        }
        struct.setInstrumentListIsSet(true);
      }
