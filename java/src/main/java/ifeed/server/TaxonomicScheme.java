            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.instanceMap = new java.util.HashMap<String,java.util.List<String>>(2*_map88.size);
                String _key89;
                java.util.List<String> _val90;
                for (int _i91 = 0; _i91 < _map88.size; ++_i91)
                {
                  _key89 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TList _list92 = iprot.readListBegin();
                    _val90 = new java.util.ArrayList<String>(_list92.size);
                    String _elem93;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.superclassMap = new java.util.HashMap<String,java.util.List<String>>(2*_map95.size);
                String _key96;
                java.util.List<String> _val97;
                for (int _i98 = 0; _i98 < _map95.size; ++_i98)
                {
                  _key96 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TList _list99 = iprot.readListBegin();
                    _val97 = new java.util.ArrayList<String>(_list99.size);
                    String _elem100;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaxonomicScheme struct) throws org.apache.thrift.TException {
      ...
      if (struct.instanceMap != null) {
        oprot.writeFieldBegin(INSTANCE_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, java.util.List<String>> _iter102 : struct.instanceMap.entrySet())
          {
      ...
      if (struct.superclassMap != null) {
        oprot.writeFieldBegin(SUPERCLASS_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, java.util.List<String>> _iter104 : struct.superclassMap.entrySet())
          {
      ...
      if (struct.isSetInstanceMap()) {
        {
          ...
          for (java.util.Map.Entry<String, java.util.List<String>> _iter106 : struct.instanceMap.entrySet())
          {
      ...
      if (struct.isSetSuperclassMap()) {
        {
          ...
          for (java.util.Map.Entry<String, java.util.List<String>> _iter108 : struct.superclassMap.entrySet())
          {
            oprot.writeString(_iter108.getKey());
            {
              oprot.writeI32(_iter108.getValue().size());
              for (String _iter109 : _iter108.getValue())
              {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.instanceMap = new java.util.HashMap<String,java.util.List<String>>(2*_map110.size);
          String _key111;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.superclassMap = new java.util.HashMap<String,java.util.List<String>>(2*_map117.size);
          String _key118;
          java.util.List<String> _val119;
          for (int _i120 = 0; _i120 < _map117.size; ++_i120)
          {
            _key118 = iprot.readString();
            {
              ...
              _val119 = new java.util.ArrayList<String>(_list121.size);
              String _elem122;
