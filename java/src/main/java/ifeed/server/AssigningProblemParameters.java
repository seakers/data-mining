            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orbitList = new java.util.ArrayList<String>(_list56.size);
                String _elem57;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instrumentList = new java.util.ArrayList<String>(_list59.size);
                String _elem60;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AssigningProblemParameters struct) throws org.apache.thrift.TException {
      ...
      if (struct.orbitList != null) {
        oprot.writeFieldBegin(ORBIT_LIST_FIELD_DESC);
        {
          ...
          for (String _iter62 : struct.orbitList)
          {
      ...
      if (struct.instrumentList != null) {
        oprot.writeFieldBegin(INSTRUMENT_LIST_FIELD_DESC);
        {
          ...
          for (String _iter63 : struct.instrumentList)
          {
      ...
      if (struct.isSetOrbitList()) {
        {
          ...
          for (String _iter64 : struct.orbitList)
          {
      ...
      if (struct.isSetInstrumentList()) {
        {
          ...
          for (String _iter65 : struct.instrumentList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.orbitList = new java.util.ArrayList<String>(_list66.size);
          String _elem67;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.instrumentList = new java.util.ArrayList<String>(_list69.size);
          String _elem70;
