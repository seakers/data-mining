...
public abstract class AssociationRuleMining extends AbstractDataMiningBase implements AbstractDataMiningAlgorithm {
    ...
    public AssociationRuleMining(List<AbstractArchitecture> architectures,
...
//            this.drivingFeatures = mRMR.minRedundancyMaxRelevance( population.size(), getDataMat(this.drivingFeatures), this.labels, this.drivingFeatures, topN);
        ...
        System.out.println("...[EOSSAssociationRuleMining] Total features found: " + extracted_features.size());
