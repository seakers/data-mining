...
//
//        params.addLeftSetGeneralizedConcept("PassiveInstrument");
//        params.addLeftSetGeneralizedConcept("LowPowerInstrument");
//        params.addLeftSetGeneralizedConcept("ActiveInstrument");
...
//
//        params.addRightSetGeneralizedConcept("Sun-synchronousOrbit");
//        params.addRightSetGeneralizedConcept("Dawn-DuskOrbit");
//        params.addRightSetGeneralizedConcept("PolarOrbit");
//        params.addRightSetGeneralizedConcept("Altitude600Orbit");
//        params.addRightSetGeneralizedConcept("AMOrbit");
...
//        for(int i = 0; i < params.getRightSetCardinality(); i++){
//            for(int j = 0; j < params.getLeftSetCardinality(); j++){
//
...
//            input.set(i * params.getLeftSetCardinality() + j);
//        }
//    }
//}
