...
public class AssigningProblemParameters implements org.apache.thrift.TBase<AssigningProblemParameters, AssigningProblemParameters._Fields>, java.io.Serializable, Cloneable, Comparable<AssigningProblemParameters> {
  ...
  public AssigningProblemParameters setOrbitList(java.util.List<java.lang.String> orbitList) {
    this.orbitList = orbitList;
    return this;
  }
  ...
  public AssigningProblemParameters setInstrumentList(java.util.List<java.lang.String> instrumentList) {
    this.instrumentList = instrumentList;
    return this;
  }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("AssigningProblemParameters(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orbitList = new java.util.ArrayList<java.lang.String>(_list56.size);
                java.lang.String _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = iprot.readString();
                  struct.orbitList.add(_elem57);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instrumentList = new java.util.ArrayList<java.lang.String>(_list59.size);
                java.lang.String _elem60;
                for (int _i61 = 0; _i61 < _list59.size; ++_i61)
                {
                  _elem60 = iprot.readString();
                  struct.instrumentList.add(_elem60);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AssigningProblemParameters struct) throws org.apache.thrift.TException {
      ...
      if (struct.orbitList != null) {
        oprot.writeFieldBegin(ORBIT_LIST_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter62 : struct.orbitList)
          {
      ...
      if (struct.instrumentList != null) {
        oprot.writeFieldBegin(INSTRUMENT_LIST_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter63 : struct.instrumentList)
          {
      ...
      if (struct.isSetOrbitList()) {
        {
          ...
          for (java.lang.String _iter64 : struct.orbitList)
          {
      ...
      if (struct.isSetInstrumentList()) {
        {
          ...
          for (java.lang.String _iter65 : struct.instrumentList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.orbitList = new java.util.ArrayList<java.lang.String>(_list66.size);
          java.lang.String _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = iprot.readString();
            struct.orbitList.add(_elem67);
          }
        }
        struct.setOrbitListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.instrumentList = new java.util.ArrayList<java.lang.String>(_list69.size);
          java.lang.String _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = iprot.readString();
            struct.instrumentList.add(_elem70);
          }
        }
        struct.setInstrumentListIsSet(true);
      }
