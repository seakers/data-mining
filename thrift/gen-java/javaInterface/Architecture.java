            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inputs = new java.util.ArrayList<java.lang.Double>(_list24.size);
                double _elem25;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Architecture struct) throws org.apache.thrift.TException {
      ...
      if (struct.inputs != null) {
        oprot.writeFieldBegin(INPUTS_FIELD_DESC);
        {
          ...
          for (double _iter30 : struct.inputs)
          {
      ...
      if (struct.isSetInputs()) {
        {
          ...
          for (double _iter32 : struct.inputs)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.inputs = new java.util.ArrayList<java.lang.Double>(_list34.size);
          double _elem35;
