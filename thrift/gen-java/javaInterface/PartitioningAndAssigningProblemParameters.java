            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orbitList = new java.util.ArrayList<java.lang.String>(_list88.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instrumentList = new java.util.ArrayList<java.lang.String>(_list91.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitioningAndAssigningProblemParameters struct) throws org.apache.thrift.TException {
      ...
      if (struct.orbitList != null) {
        oprot.writeFieldBegin(ORBIT_LIST_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter94 : struct.orbitList)
          {
      ...
      if (struct.instrumentList != null) {
        oprot.writeFieldBegin(INSTRUMENT_LIST_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter95 : struct.instrumentList)
          {
      ...
      if (struct.isSetOrbitList()) {
        {
          ...
          for (java.lang.String _iter96 : struct.orbitList)
          {
      ...
      if (struct.isSetInstrumentList()) {
        {
          ...
          for (java.lang.String _iter97 : struct.instrumentList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.orbitList = new java.util.ArrayList<java.lang.String>(_list98.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.instrumentList = new java.util.ArrayList<java.lang.String>(_list101.size);
