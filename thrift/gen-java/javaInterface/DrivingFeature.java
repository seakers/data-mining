...
public class DrivingFeature implements org.apache.thrift.TBase<DrivingFeature, DrivingFeature._Fields>, java.io.Serializable, Cloneable, Comparable<DrivingFeature> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DrivingFeature");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DrivingFeatureStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DrivingFeatureTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DrivingFeature.class, metaDataMap);
  }

  public DrivingFeature() {
  }
   ...
   */
  public DrivingFeature(DrivingFeature other) {
  ...
  public DrivingFeature deepCopy() {
    return new DrivingFeature(this);
  }
  ...
  public DrivingFeature setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public DrivingFeature setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public DrivingFeature setExpression(java.lang.String expression) {
    this.expression = expression;
    return this;
  }
  ...
  public DrivingFeature setMetrics(java.util.List<java.lang.Double> metrics) {
    this.metrics = metrics;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DrivingFeature)
      return this.equals((DrivingFeature)that);
    return false;
  }

  public boolean equals(DrivingFeature that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DrivingFeature(");
    boolean first = true;
  ...
  private static class DrivingFeatureStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DrivingFeatureStandardScheme getScheme() {
      return new DrivingFeatureStandardScheme();
    }
  }

  private static class DrivingFeatureStandardScheme extends org.apache.thrift.scheme.StandardScheme<DrivingFeature> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DrivingFeature struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DrivingFeature struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DrivingFeatureTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DrivingFeatureTupleScheme getScheme() {
      return new DrivingFeatureTupleScheme();
    }
  }

  private static class DrivingFeatureTupleScheme extends org.apache.thrift.scheme.TupleScheme<DrivingFeature> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DrivingFeature struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DrivingFeature struct) throws org.apache.thrift.TException {
