...
public class DataMiningInterface {
  ...
  public interface Iface {
    ...
    public java.util.List<DrivingFeature> getDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, double supp, double conf, double lift) throws org.apache.thrift.TException;

    public java.util.List<DrivingFeature> getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.util.List<DrivingFeature> current_features, double supp, double conf, double lift) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler) throws org.apache.thrift.TException;

    public void getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.util.List<DrivingFeature> current_features, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, double supp, double conf, double lift) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<DrivingFeature> recv_getDrivingFeatures() throws org.apache.thrift.TException
    {
    ...
    public java.util.List<DrivingFeature> getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.util.List<DrivingFeature> current_features, double supp, double conf, double lift) throws org.apache.thrift.TException
    {
      send_getMarginalDrivingFeatures(behavioral, non_behavioral, all_archs, current_features, supp, conf, lift);
      return recv_getMarginalDrivingFeatures();
    }

    public void send_getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.util.List<DrivingFeature> current_features, double supp, double conf, double lift) throws org.apache.thrift.TException
    {
      getMarginalDrivingFeatures_args args = new getMarginalDrivingFeatures_args();
      args.setBehavioral(behavioral);
      args.setNon_behavioral(non_behavioral);
      args.setAll_archs(all_archs);
      args.setCurrent_features(current_features);
      args.setSupp(supp);
      args.setConf(conf);
      args.setLift(lift);
    ...
    public java.util.List<DrivingFeature> recv_getMarginalDrivingFeatures() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getDrivingFeatures_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<DrivingFeature>> {
      private java.util.List<java.lang.Integer> behavioral;
      private java.util.List<java.lang.Integer> non_behavioral;
      private java.util.List<Architecture> all_archs;
      private double supp;
      private double conf;
      private double lift;
      public getDrivingFeatures_call(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public java.util.List<DrivingFeature> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.util.List<DrivingFeature> current_features, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getMarginalDrivingFeatures_call method_call = new getMarginalDrivingFeatures_call(behavioral, non_behavioral, all_archs, current_features, supp, conf, lift, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getMarginalDrivingFeatures_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<DrivingFeature>> {
      private java.util.List<java.lang.Integer> behavioral;
      private java.util.List<java.lang.Integer> non_behavioral;
      private java.util.List<Architecture> all_archs;
      private java.util.List<DrivingFeature> current_features;
      private double supp;
      private double conf;
      private double lift;
      public getMarginalDrivingFeatures_call(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.util.List<DrivingFeature> current_features, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.behavioral = behavioral;
        this.non_behavioral = non_behavioral;
        this.all_archs = all_archs;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getMarginalDrivingFeatures<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getMarginalDrivingFeatures_args> {
      ...
      public getMarginalDrivingFeatures_result getResult(I iface, getMarginalDrivingFeatures_args args) throws org.apache.thrift.TException {
        getMarginalDrivingFeatures_result result = new getMarginalDrivingFeatures_result();
        result.success = iface.getMarginalDrivingFeatures(args.behavioral, args.non_behavioral, args.all_archs, args.current_features, args.supp, args.conf, args.lift);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getDrivingFeatures<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getDrivingFeatures_args, java.util.List<DrivingFeature>> {
      public getDrivingFeatures() {
        super("getDrivingFeatures");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>>() { 
          public void onComplete(java.util.List<DrivingFeature> o) {
            getDrivingFeatures_result result = new getDrivingFeatures_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getDrivingFeatures_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler) throws org.apache.thrift.TException {
        iface.getDrivingFeatures(args.behavioral, args.non_behavioral, args.all_archs, args.supp, args.conf, args.lift,resultHandler);
      }
    }

    public static class getMarginalDrivingFeatures<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getMarginalDrivingFeatures_args, java.util.List<DrivingFeature>> {
      public getMarginalDrivingFeatures() {
        super("getMarginalDrivingFeatures");
      }
      ...
      public void start(I iface, getMarginalDrivingFeatures_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<DrivingFeature>> resultHandler) throws org.apache.thrift.TException {
        iface.getMarginalDrivingFeatures(args.behavioral, args.non_behavioral, args.all_archs, args.current_features, args.supp, args.conf, args.lift,resultHandler);
      }
    }
...
;
  ...
  public static class getDrivingFeatures_args implements org.apache.thrift.TBase<getDrivingFeatures_args, getDrivingFeatures_args._Fields>, java.io.Serializable, Cloneable, Comparable<getDrivingFeatures_args>   {
    ...
    public java.util.List<Architecture> all_archs; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.ALL_ARCHS, new org.apache.thrift.meta_data.FieldMetaData("all_archs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Architecture.class))));
    ...
    public getDrivingFeatures_args(
      ...
      java.util.List<Architecture> all_archs,
      double supp,
      double conf,
      double lift)
    {
    ...
    public getDrivingFeatures_args(getDrivingFeatures_args other) {
      ...
      if (other.isSetAll_archs()) {
        java.util.List<Architecture> __this__all_archs = new java.util.ArrayList<Architecture>(other.all_archs.size());
        for (Architecture other_element : other.all_archs) {
          __this__all_archs.add(new Architecture(other_element));
        }
    ...
    public java.util.Iterator<Architecture> getAll_archsIterator() {
      return (this.all_archs == null) ? null : this.all_archs.iterator();
    }

    public void addToAll_archs(Architecture elem) {
      if (this.all_archs == null) {
        this.all_archs = new java.util.ArrayList<Architecture>();
      }
      this.all_archs.add(elem);
    }

    public java.util.List<Architecture> getAll_archs() {
      return this.all_archs;
    }

    public getDrivingFeatures_args setAll_archs(java.util.List<Architecture> all_archs) {
      this.all_archs = all_archs;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case ALL_ARCHS:
        if (value == null) {
          ...
          setAll_archs((java.util.List<Architecture>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.behavioral = new java.util.ArrayList<java.lang.Integer>(_list8.size);
                  int _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = iprot.readI32();
                    struct.behavioral.add(_elem9);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.non_behavioral = new java.util.ArrayList<java.lang.Integer>(_list11.size);
                  int _elem12;
                  for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                  {
                    _elem12 = iprot.readI32();
                    struct.non_behavioral.add(_elem12);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.all_archs = new java.util.ArrayList<Architecture>(_list14.size);
                  Architecture _elem15;
                  for (int _i16 = 0; _i16 < _list14.size; ++_i16)
                  {
                    _elem15 = new Architecture();
                    _elem15.read(iprot);
                    struct.all_archs.add(_elem15);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getDrivingFeatures_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.behavioral != null) {
          oprot.writeFieldBegin(BEHAVIORAL_FIELD_DESC);
          {
            ...
            for (int _iter17 : struct.behavioral)
            {
        ...
        if (struct.non_behavioral != null) {
          oprot.writeFieldBegin(NON_BEHAVIORAL_FIELD_DESC);
          {
            ...
            for (int _iter18 : struct.non_behavioral)
            {
        ...
        if (struct.all_archs != null) {
          oprot.writeFieldBegin(ALL_ARCHS_FIELD_DESC);
          {
            ...
            for (Architecture _iter19 : struct.all_archs)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetBehavioral()) {
          {
            ...
            for (int _iter20 : struct.behavioral)
            {
        ...
        if (struct.isSetNon_behavioral()) {
          {
            ...
            for (int _iter21 : struct.non_behavioral)
            {
        ...
        if (struct.isSetAll_archs()) {
          {
            ...
            for (Architecture _iter22 : struct.all_archs)
            {
              _iter22.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.behavioral = new java.util.ArrayList<java.lang.Integer>(_list23.size);
            int _elem24;
            for (int _i25 = 0; _i25 < _list23.size; ++_i25)
            {
              _elem24 = iprot.readI32();
              struct.behavioral.add(_elem24);
            }
          }
          struct.setBehavioralIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.non_behavioral = new java.util.ArrayList<java.lang.Integer>(_list26.size);
            int _elem27;
            for (int _i28 = 0; _i28 < _list26.size; ++_i28)
            {
              _elem27 = iprot.readI32();
              struct.non_behavioral.add(_elem27);
            }
          }
          struct.setNon_behavioralIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.all_archs = new java.util.ArrayList<Architecture>(_list29.size);
            Architecture _elem30;
            for (int _i31 = 0; _i31 < _list29.size; ++_i31)
            {
              _elem30 = new Architecture();
              _elem30.read(iprot);
              struct.all_archs.add(_elem30);
            }
          }
          struct.setAll_archsIsSet(true);
        }
  ...
  public static class getDrivingFeatures_result implements org.apache.thrift.TBase<getDrivingFeatures_result, getDrivingFeatures_result._Fields>, java.io.Serializable, Cloneable, Comparable<getDrivingFeatures_result>   {
    ...
    public java.util.List<DrivingFeature> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DrivingFeature.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getDrivingFeatures_result(
      java.util.List<DrivingFeature> success)
    {
      this();
    ...
    public getDrivingFeatures_result(getDrivingFeatures_result other) {
      if (other.isSetSuccess()) {
        java.util.List<DrivingFeature> __this__success = new java.util.ArrayList<DrivingFeature>(other.success.size());
        for (DrivingFeature other_element : other.success) {
          __this__success.add(new DrivingFeature(other_element));
        }
    ...
    public java.util.Iterator<DrivingFeature> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(DrivingFeature elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<DrivingFeature>();
      }
      this.success.add(elem);
    }

    public java.util.List<DrivingFeature> getSuccess() {
      return this.success;
    }

    public getDrivingFeatures_result setSuccess(java.util.List<DrivingFeature> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<DrivingFeature>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<DrivingFeature>(_list32.size);
                  DrivingFeature _elem33;
                  for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                  {
                    _elem33 = new DrivingFeature();
                    _elem33.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getDrivingFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (DrivingFeature _iter35 : struct.success)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (DrivingFeature _iter36 : struct.success)
            {
              _iter36.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<DrivingFeature>(_list37.size);
            DrivingFeature _elem38;
            for (int _i39 = 0; _i39 < _list37.size; ++_i39)
            {
              _elem38 = new DrivingFeature();
              _elem38.read(iprot);
  ...
  public static class getMarginalDrivingFeatures_args implements org.apache.thrift.TBase<getMarginalDrivingFeatures_args, getMarginalDrivingFeatures_args._Fields>, java.io.Serializable, Cloneable, Comparable<getMarginalDrivingFeatures_args>   {
    ...
    private static final org.apache.thrift.protocol.TField NON_BEHAVIORAL_FIELD_DESC = new org.apache.thrift.protocol.TField("non_behavioral", org.apache.thrift.protocol.TType.LIST, (short)2);
    private static final org.apache.thrift.protocol.TField ALL_ARCHS_FIELD_DESC = new org.apache.thrift.protocol.TField("all_archs", org.apache.thrift.protocol.TType.LIST, (short)3);
    private static final org.apache.thrift.protocol.TField CURRENT_FEATURES_FIELD_DESC = new org.apache.thrift.protocol.TField("current_features", org.apache.thrift.protocol.TType.LIST, (short)4);
    ...
    public java.util.List<java.lang.Integer> non_behavioral; // required
    public java.util.List<Architecture> all_archs; // required
    public java.util.List<DrivingFeature> current_features; // required
    public double supp; // required
    public double conf; // required
    public double lift; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      NON_BEHAVIORAL((short)2, "non_behavioral"),
      ALL_ARCHS((short)3, "all_archs"),
      CURRENT_FEATURES((short)4, "current_features"),
      SUPP((short)5, "supp"),
      CONF((short)6, "conf"),
      LIFT((short)7, "lift");
    ...
    static {
      ...
      tmpMap.put(_Fields.ALL_ARCHS, new org.apache.thrift.meta_data.FieldMetaData("all_archs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Architecture.class))));
      tmpMap.put(_Fields.CURRENT_FEATURES, new org.apache.thrift.meta_data.FieldMetaData("current_features", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DrivingFeature.class))));
      tmpMap.put(_Fields.SUPP, new org.apache.thrift.meta_data.FieldMetaData("supp", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    ...
    public getMarginalDrivingFeatures_args(
      ...
      java.util.List<java.lang.Integer> non_behavioral,
      java.util.List<Architecture> all_archs,
      java.util.List<DrivingFeature> current_features,
      double supp,
      double conf,
      double lift)
    {
    ...
    public getMarginalDrivingFeatures_args(getMarginalDrivingFeatures_args other) {
      ...
      if (other.isSetCurrent_features()) {
        java.util.List<DrivingFeature> __this__current_features = new java.util.ArrayList<DrivingFeature>(other.current_features.size());
        for (DrivingFeature other_element : other.current_features) {
          __this__current_features.add(new DrivingFeature(other_element));
        }
        this.current_features = __this__current_features;
      }
      this.supp = other.supp;
      this.conf = other.conf;
      this.lift = other.lift;
    ...
    public getMarginalDrivingFeatures_args setAll_archs(java.util.List<Architecture> all_archs) {
      this.all_archs = all_archs;
      return this;
    }
    ...
    public int getCurrent_featuresSize() {
      return (this.current_features == null) ? 0 : this.current_features.size();
    }

    public java.util.Iterator<DrivingFeature> getCurrent_featuresIterator() {
      return (this.current_features == null) ? null : this.current_features.iterator();
    }

    public void addToCurrent_features(DrivingFeature elem) {
      if (this.current_features == null) {
        this.current_features = new java.util.ArrayList<DrivingFeature>();
      }
      this.current_features.add(elem);
    }

    public java.util.List<DrivingFeature> getCurrent_features() {
      return this.current_features;
    }

    public getMarginalDrivingFeatures_args setCurrent_features(java.util.List<DrivingFeature> current_features) {
      this.current_features = current_features;
      return this;
    }

    public void unsetCurrent_features() {
      this.current_features = null;
    }

    /** Returns true if field current_features is set (has been assigned a value) and false otherwise */
    public boolean isSetCurrent_features() {
      return this.current_features != null;
    }

    public void setCurrent_featuresIsSet(boolean value) {
      if (!value) {
        this.current_features = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case CURRENT_FEATURES:
        if (value == null) {
          unsetCurrent_features();
        } else {
          setCurrent_features((java.util.List<DrivingFeature>)value);
        }
        break;
    ...
    public boolean equals(getMarginalDrivingFeatures_args that) {
      ...
      boolean this_present_current_features = true && this.isSetCurrent_features();
      boolean that_present_current_features = true && that.isSetCurrent_features();
      if (this_present_current_features || that_present_current_features) {
        if (!(this_present_current_features && that_present_current_features))
          return false;
        if (!this.current_features.equals(that.current_features))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetCurrent_features()) ? 131071 : 524287);
      if (isSetCurrent_features())
        hashCode = hashCode * 8191 + current_features.hashCode();
    ...
    public int compareTo(getMarginalDrivingFeatures_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetCurrent_features()).compareTo(other.isSetCurrent_features());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetCurrent_features()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.current_features, other.current_features);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("current_features:");
      if (this.current_features == null) {
        sb.append("null");
      } else {
        sb.append(this.current_features);
      }
      first = false;
      if (!first) sb.append(", ");
      sb.append("supp:");
    ...
    private static class getMarginalDrivingFeatures_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getMarginalDrivingFeatures_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.all_archs = new java.util.ArrayList<Architecture>(_list46.size);
                  Architecture _elem47;
                  for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                  {
                    _elem47 = new Architecture();
                    _elem47.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.current_features = new java.util.ArrayList<DrivingFeature>(_list49.size);
                  DrivingFeature _elem50;
                  for (int _i51 = 0; _i51 < _list49.size; ++_i51)
                  {
                    _elem50 = new DrivingFeature();
                    _elem50.read(iprot);
                    struct.current_features.add(_elem50);
                  }
                  iprot.readListEnd();
                }
                struct.setCurrent_featuresIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getMarginalDrivingFeatures_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.all_archs != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.all_archs.size()));
            for (Architecture _iter54 : struct.all_archs)
            {
              _iter54.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.current_features != null) {
          oprot.writeFieldBegin(CURRENT_FEATURES_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.current_features.size()));
            for (DrivingFeature _iter55 : struct.current_features)
            {
              _iter55.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getMarginalDrivingFeatures_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getMarginalDrivingFeatures_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getMarginalDrivingFeatures_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetCurrent_features()) {
          optionals.set(3);
        }
        if (struct.isSetSupp()) {
          optionals.set(4);
        ...
        if (struct.isSetBehavioral()) {
          {
            oprot.writeI32(struct.behavioral.size());
            for (int _iter56 : struct.behavioral)
            {
        ...
        if (struct.isSetNon_behavioral()) {
          {
            oprot.writeI32(struct.non_behavioral.size());
            for (int _iter57 : struct.non_behavioral)
            {
        ...
        if (struct.isSetAll_archs()) {
          {
            oprot.writeI32(struct.all_archs.size());
            for (Architecture _iter58 : struct.all_archs)
            {
              _iter58.write(oprot);
            }
          }
        ...
        if (struct.isSetCurrent_features()) {
          {
            oprot.writeI32(struct.current_features.size());
            for (DrivingFeature _iter59 : struct.current_features)
            {
              _iter59.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.behavioral = new java.util.ArrayList<java.lang.Integer>(_list60.size);
            int _elem61;
            for (int _i62 = 0; _i62 < _list60.size; ++_i62)
            {
              _elem61 = iprot.readI32();
              struct.behavioral.add(_elem61);
            }
          }
          struct.setBehavioralIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.non_behavioral = new java.util.ArrayList<java.lang.Integer>(_list63.size);
            int _elem64;
            for (int _i65 = 0; _i65 < _list63.size; ++_i65)
            {
              _elem64 = iprot.readI32();
              struct.non_behavioral.add(_elem64);
            }
          }
          struct.setNon_behavioralIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.all_archs = new java.util.ArrayList<Architecture>(_list66.size);
            Architecture _elem67;
            for (int _i68 = 0; _i68 < _list66.size; ++_i68)
            {
              _elem67 = new Architecture();
              _elem67.read(iprot);
              struct.all_archs.add(_elem67);
            }
          }
          struct.setAll_archsIsSet(true);
        }
        if (incoming.get(3)) {
          {
            ...
            struct.current_features = new java.util.ArrayList<DrivingFeature>(_list69.size);
            DrivingFeature _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = new DrivingFeature();
              _elem70.read(iprot);
              struct.current_features.add(_elem70);
            }
          }
          struct.setCurrent_featuresIsSet(true);
        }
  ...
  public static class getMarginalDrivingFeatures_result implements org.apache.thrift.TBase<getMarginalDrivingFeatures_result, getMarginalDrivingFeatures_result._Fields>, java.io.Serializable, Cloneable, Comparable<getMarginalDrivingFeatures_result>   {
    ...
    public getMarginalDrivingFeatures_result setSuccess(java.util.List<DrivingFeature> success) {
      this.success = success;
      return this;
    }
    ...
    private static class getMarginalDrivingFeatures_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getMarginalDrivingFeatures_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<DrivingFeature>(_list72.size);
                  DrivingFeature _elem73;
                  for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                  {
                    _elem73 = new DrivingFeature();
                    _elem73.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getMarginalDrivingFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (DrivingFeature _iter75 : struct.success)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getMarginalDrivingFeatures_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getMarginalDrivingFeatures_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getMarginalDrivingFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (DrivingFeature _iter76 : struct.success)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<DrivingFeature>(_list77.size);
            DrivingFeature _elem78;
            for (int _i79 = 0; _i79 < _list77.size; ++_i79)
            {
              _elem78 = new DrivingFeature();
              _elem78.read(iprot);
