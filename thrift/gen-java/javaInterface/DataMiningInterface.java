...
public class DataMiningInterface {
  ...
  public interface Iface {
    ...
    public java.util.List<Feature> getDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, double supp, double conf, double lift) throws org.apache.thrift.TException;

    public java.util.List<Feature> getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.lang.String feature, java.util.List<java.lang.Integer> archs_with_feature, double supp, double conf, double lift) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.lang.String feature, java.util.List<java.lang.Integer> archs_with_feature, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Feature>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getMarginalDrivingFeatures(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.lang.String feature, java.util.List<java.lang.Integer> archs_with_feature, double supp, double conf, double lift) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getMarginalDrivingFeatures_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Feature>> {
      ...
      private double conf;
      private double lift;
      public getMarginalDrivingFeatures_call(java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<Architecture> all_archs, java.lang.String feature, java.util.List<java.lang.Integer> archs_with_feature, double supp, double conf, double lift, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Feature>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.behavioral = behavioral;
        this.non_behavioral = non_behavioral;
        this.all_archs = all_archs;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Feature>(_list32.size);
                  Feature _elem33;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getDrivingFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Feature _iter35 : struct.success)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Feature _iter36 : struct.success)
            {
              _iter36.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Feature>(_list37.size);
            Feature _elem38;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.archs_with_feature = new java.util.ArrayList<java.lang.Integer>(_list49.size);
                  int _elem50;
                  for (int _i51 = 0; _i51 < _list49.size; ++_i51)
                  {
                    _elem50 = iprot.readI32();
                    struct.archs_with_feature.add(_elem50);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getMarginalDrivingFeatures_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.archs_with_feature != null) {
          oprot.writeFieldBegin(ARCHS_WITH_FEATURE_FIELD_DESC);
          {
            ...
            for (int _iter55 : struct.archs_with_feature)
            {
        ...
        if (struct.isSetArchs_with_feature()) {
          {
            ...
            for (int _iter59 : struct.archs_with_feature)
            {
        ...
        if (incoming.get(4)) {
          {
            ...
            struct.archs_with_feature = new java.util.ArrayList<java.lang.Integer>(_list69.size);
            int _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = iprot.readI32();
              struct.archs_with_feature.add(_elem70);
            }
          }
          struct.setArchs_with_featureIsSet(true);
        }
    ...
    private static class getMarginalDrivingFeatures_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getMarginalDrivingFeatures_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Feature>(_list72.size);
                  Feature _elem73;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getMarginalDrivingFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Feature _iter75 : struct.success)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getMarginalDrivingFeatures_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getMarginalDrivingFeatures_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getMarginalDrivingFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Feature _iter76 : struct.success)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Feature>(_list77.size);
            Feature _elem78;
