...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2018-03-28")
public class DataMiningInterface {
  ...
  public interface Iface {
    ...
    public java.util.List<Feature> getDrivingFeaturesEpsilonMOEA(java.lang.String problem, java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<BinaryInputArchitecture> all_archs) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getDrivingFeaturesEpsilonMOEA(java.lang.String problem, java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<BinaryInputArchitecture> all_archs, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Feature>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.util.List<Feature> getDrivingFeaturesEpsilonMOEA(java.lang.String problem, java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<BinaryInputArchitecture> all_archs) throws org.apache.thrift.TException
    {
      send_getDrivingFeaturesEpsilonMOEA(problem, behavioral, non_behavioral, all_archs);
      return recv_getDrivingFeaturesEpsilonMOEA();
    }

    public void send_getDrivingFeaturesEpsilonMOEA(java.lang.String problem, java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<BinaryInputArchitecture> all_archs) throws org.apache.thrift.TException
    {
      getDrivingFeaturesEpsilonMOEA_args args = new getDrivingFeaturesEpsilonMOEA_args();
      args.setProblem(problem);
      args.setBehavioral(behavioral);
      args.setNon_behavioral(non_behavioral);
      args.setAll_archs(all_archs);
      sendBase("getDrivingFeaturesEpsilonMOEA", args);
    }

    public java.util.List<Feature> recv_getDrivingFeaturesEpsilonMOEA() throws org.apache.thrift.TException
    {
      getDrivingFeaturesEpsilonMOEA_result result = new getDrivingFeaturesEpsilonMOEA_result();
      receiveBase(result, "getDrivingFeaturesEpsilonMOEA");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getDrivingFeaturesEpsilonMOEA failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getDrivingFeaturesEpsilonMOEA(java.lang.String problem, java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<BinaryInputArchitecture> all_archs, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Feature>> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getDrivingFeaturesEpsilonMOEA_call method_call = new getDrivingFeaturesEpsilonMOEA_call(problem, behavioral, non_behavioral, all_archs, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getDrivingFeaturesEpsilonMOEA_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Feature>> {
      private java.lang.String problem;
      private java.util.List<java.lang.Integer> behavioral;
      private java.util.List<java.lang.Integer> non_behavioral;
      private java.util.List<BinaryInputArchitecture> all_archs;
      public getDrivingFeaturesEpsilonMOEA_call(java.lang.String problem, java.util.List<java.lang.Integer> behavioral, java.util.List<java.lang.Integer> non_behavioral, java.util.List<BinaryInputArchitecture> all_archs, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Feature>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.problem = problem;
        this.behavioral = behavioral;
        this.non_behavioral = non_behavioral;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getDrivingFeaturesEpsilonMOEA", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getDrivingFeaturesEpsilonMOEA_args args = new getDrivingFeaturesEpsilonMOEA_args();
        args.setProblem(problem);
        args.setBehavioral(behavioral);
        args.setNon_behavioral(non_behavioral);
      ...
      public java.util.List<Feature> getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getDrivingFeaturesEpsilonMOEA();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<java.lang.String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<java.lang.String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getDrivingFeaturesEpsilonMOEA", new getDrivingFeaturesEpsilonMOEA());
    ...
    public static class getDrivingFeaturesEpsilonMOEA<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getDrivingFeaturesEpsilonMOEA_args> {
      public getDrivingFeaturesEpsilonMOEA() {
        super("getDrivingFeaturesEpsilonMOEA");
      }

      public getDrivingFeaturesEpsilonMOEA_args getEmptyArgsInstance() {
        return new getDrivingFeaturesEpsilonMOEA_args();
      }
      ...
      public getDrivingFeaturesEpsilonMOEA_result getResult(I iface, getDrivingFeaturesEpsilonMOEA_args args) throws org.apache.thrift.TException {
        getDrivingFeaturesEpsilonMOEA_result result = new getDrivingFeaturesEpsilonMOEA_result();
        result.success = iface.getDrivingFeaturesEpsilonMOEA(args.problem, args.behavioral, args.non_behavioral, args.all_archs);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getDrivingFeaturesEpsilonMOEA<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getDrivingFeaturesEpsilonMOEA_args, java.util.List<Feature>> {
      public getDrivingFeaturesEpsilonMOEA() {
        super("getDrivingFeaturesEpsilonMOEA");
      }
      ...
      public void start(I iface, getDrivingFeaturesEpsilonMOEA_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Feature>> resultHandler) throws org.apache.thrift.TException {
        iface.getDrivingFeaturesEpsilonMOEA(args.problem, args.behavioral, args.non_behavioral, args.all_archs,resultHandler);
      }
    }
...
;
  ...
  public static class getDrivingFeaturesEpsilonMOEA_args implements org.apache.thrift.TBase<getDrivingFeaturesEpsilonMOEA_args, getDrivingFeaturesEpsilonMOEA_args._Fields>, java.io.Serializable, Cloneable, Comparable<getDrivingFeaturesEpsilonMOEA_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getDrivingFeaturesEpsilonMOEA_args");
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getDrivingFeaturesEpsilonMOEA_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getDrivingFeaturesEpsilonMOEA_argsTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.ALL_ARCHS, new org.apache.thrift.meta_data.FieldMetaData("all_archs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BinaryInputArchitecture.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getDrivingFeaturesEpsilonMOEA_args.class, metaDataMap);
    }

    public getDrivingFeaturesEpsilonMOEA_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getDrivingFeaturesEpsilonMOEA_args(getDrivingFeaturesEpsilonMOEA_args other) {
      if (other.isSetProblem()) {
        this.problem = other.problem;
      }
      if (other.isSetBehavioral()) {
    ...
    public getDrivingFeaturesEpsilonMOEA_args deepCopy() {
      return new getDrivingFeaturesEpsilonMOEA_args(this);
    }
    ...
    public getDrivingFeaturesEpsilonMOEA_args setProblem(java.lang.String problem) {
      this.problem = problem;
      return this;
    }
    ...
    public getDrivingFeaturesEpsilonMOEA_args setBehavioral(java.util.List<java.lang.Integer> behavioral) {
      this.behavioral = behavioral;
      return this;
    }
    ...
    public getDrivingFeaturesEpsilonMOEA_args setNon_behavioral(java.util.List<java.lang.Integer> non_behavioral) {
      this.non_behavioral = non_behavioral;
      return this;
    }
    ...
    public getDrivingFeaturesEpsilonMOEA_args setAll_archs(java.util.List<BinaryInputArchitecture> all_archs) {
      this.all_archs = all_archs;
      return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof getDrivingFeaturesEpsilonMOEA_args)
        return this.equals((getDrivingFeaturesEpsilonMOEA_args)that);
      return false;
    }

    public boolean equals(getDrivingFeaturesEpsilonMOEA_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getDrivingFeaturesEpsilonMOEA_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("getDrivingFeaturesEpsilonMOEA_args(");
      boolean first = true;
    ...
    private static class getDrivingFeaturesEpsilonMOEA_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getDrivingFeaturesEpsilonMOEA_argsStandardScheme getScheme() {
        return new getDrivingFeaturesEpsilonMOEA_argsStandardScheme();
      }
    }

    private static class getDrivingFeaturesEpsilonMOEA_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getDrivingFeaturesEpsilonMOEA_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getDrivingFeaturesEpsilonMOEA_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getDrivingFeaturesEpsilonMOEA_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getDrivingFeaturesEpsilonMOEA_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getDrivingFeaturesEpsilonMOEA_argsTupleScheme getScheme() {
        return new getDrivingFeaturesEpsilonMOEA_argsTupleScheme();
      }
    }

    private static class getDrivingFeaturesEpsilonMOEA_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getDrivingFeaturesEpsilonMOEA_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getDrivingFeaturesEpsilonMOEA_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetProblem()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getDrivingFeaturesEpsilonMOEA_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
  ...
  public static class getDrivingFeaturesEpsilonMOEA_result implements org.apache.thrift.TBase<getDrivingFeaturesEpsilonMOEA_result, getDrivingFeaturesEpsilonMOEA_result._Fields>, java.io.Serializable, Cloneable, Comparable<getDrivingFeaturesEpsilonMOEA_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getDrivingFeaturesEpsilonMOEA_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.LIST, (short)0);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getDrivingFeaturesEpsilonMOEA_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getDrivingFeaturesEpsilonMOEA_resultTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Feature.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getDrivingFeaturesEpsilonMOEA_result.class, metaDataMap);
    }

    public getDrivingFeaturesEpsilonMOEA_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getDrivingFeaturesEpsilonMOEA_result(getDrivingFeaturesEpsilonMOEA_result other) {
      if (other.isSetSuccess()) {
        java.util.List<Feature> __this__success = new java.util.ArrayList<Feature>(other.success.size());
        for (Feature other_element : other.success) {
          __this__success.add(new Feature(other_element));
    ...
    public getDrivingFeaturesEpsilonMOEA_result deepCopy() {
      return new getDrivingFeaturesEpsilonMOEA_result(this);
    }
    ...
    public getDrivingFeaturesEpsilonMOEA_result setSuccess(java.util.List<Feature> success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof getDrivingFeaturesEpsilonMOEA_result)
        return this.equals((getDrivingFeaturesEpsilonMOEA_result)that);
      return false;
    }

    public boolean equals(getDrivingFeaturesEpsilonMOEA_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getDrivingFeaturesEpsilonMOEA_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("getDrivingFeaturesEpsilonMOEA_result(");
      boolean first = true;
    ...
    private static class getDrivingFeaturesEpsilonMOEA_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getDrivingFeaturesEpsilonMOEA_resultStandardScheme getScheme() {
        return new getDrivingFeaturesEpsilonMOEA_resultStandardScheme();
      }
    }

    private static class getDrivingFeaturesEpsilonMOEA_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getDrivingFeaturesEpsilonMOEA_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getDrivingFeaturesEpsilonMOEA_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getDrivingFeaturesEpsilonMOEA_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getDrivingFeaturesEpsilonMOEA_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getDrivingFeaturesEpsilonMOEA_resultTupleScheme getScheme() {
        return new getDrivingFeaturesEpsilonMOEA_resultTupleScheme();
      }
    }

    private static class getDrivingFeaturesEpsilonMOEA_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getDrivingFeaturesEpsilonMOEA_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getDrivingFeaturesEpsilonMOEA_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getDrivingFeaturesEpsilonMOEA_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.expressions = new java.util.ArrayList<java.lang.String>(_list280.size);
                  java.lang.String _elem281;
                  for (int _i282 = 0; _i282 < _list280.size; ++_i282)
                  {
                    _elem281 = iprot.readString();
                    struct.expressions.add(_elem281);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, computeComplexityOfFeatures_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.expressions != null) {
          oprot.writeFieldBegin(EXPRESSIONS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter283 : struct.expressions)
            {
        ...
        if (struct.isSetExpressions()) {
          {
            ...
            for (java.lang.String _iter284 : struct.expressions)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.expressions = new java.util.ArrayList<java.lang.String>(_list285.size);
            java.lang.String _elem286;
            for (int _i287 = 0; _i287 < _list285.size; ++_i287)
            {
              _elem286 = iprot.readString();
              struct.expressions.add(_elem286);
            }
          }
          struct.setExpressionsIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<java.lang.Double>(_list288.size);
                  double _elem289;
                  for (int _i290 = 0; _i290 < _list288.size; ++_i290)
                  {
                    _elem289 = iprot.readDouble();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, computeComplexityOfFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (double _iter291 : struct.success)
            {
    ...
    private static class computeComplexityOfFeatures_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<computeComplexityOfFeatures_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, computeComplexityOfFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (double _iter292 : struct.success)
            {
              oprot.writeDouble(_iter292);
            }
          }
        }
      }
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, computeComplexityOfFeatures_result struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list293 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
            struct.success = new java.util.ArrayList<java.lang.Double>(_list293.size);
            double _elem294;
            for (int _i295 = 0; _i295 < _list293.size; ++_i295)
            {
              _elem294 = iprot.readDouble();
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<java.lang.Integer>(_list296.size);
                  int _elem297;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, computeAlgebraicTypicality_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (int _iter299 : struct.success)
            {
    ...
    private static class computeAlgebraicTypicality_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<computeAlgebraicTypicality_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, computeAlgebraicTypicality_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (int _iter300 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<java.lang.Integer>(_list301.size);
            int _elem302;
    ...
    private static class computeAlgebraicTypicalityWithStringInput_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<computeAlgebraicTypicalityWithStringInput_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<java.lang.Integer>(_list304.size);
                  int _elem305;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, computeAlgebraicTypicalityWithStringInput_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.success.size()));
            for (int _iter307 : struct.success)
            {
    ...
    private static class computeAlgebraicTypicalityWithStringInput_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<computeAlgebraicTypicalityWithStringInput_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, computeAlgebraicTypicalityWithStringInput_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (int _iter308 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<java.lang.Integer>(_list309.size);
            int _elem310;
