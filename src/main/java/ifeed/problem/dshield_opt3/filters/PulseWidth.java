 ...
 * @author bang
 */
public class PulseWidth extends AbstractFilter {

    protected Params params;
    private final double n;

    public PulseWidth(BaseParams params, double n){
        super(params);
    ...
    @Override
    public String getName(){return "PulseWidth";}

    @Override
    public String toString(){
        return "{PulseWidth[" + this.n + "]}";
    }
}
