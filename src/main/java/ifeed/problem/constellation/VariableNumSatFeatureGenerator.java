...
import ifeed.problem.constellation.filters.InclinationRange;
import ifeed.problem.constellation.filters.NumSats;
 ...
 * @author bang
 */
public class VariableNumSatFeatureGenerator extends AbstractFeatureGenerator{

    private AbstractConstellationProblemParams params;
    private int numSats;
    private String[] orbitalParameters;

    public VariableNumSatFeatureGenerator(BaseParams params){
        super(params);
