...
public class mineFromCsv {
    public static void main(String[] args){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("arches.csv"))) {
            String line;
            br.readLine();
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            dvs.add(Double.parseDouble(records.get(i).get(5))*1e-6);
            dvs.add(Double.parseDouble(records.get(i).get(6)));
        ...
        List<Feature> features = handler.getDrivingFeaturesContinuous("dshield",behavioral,nonBehavioral,arches,0.0,0.1,1.0);
