...
public class mineFromCsv_opt2 {
    public static void main(String[] args){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("opt2_arches.csv"))) {
            String line;
            br.readLine();
        ...
        List<Feature> features = handler.getDrivingFeaturesContinuous("dshield_opt2",behavioral,nonBehavioral,arches,0.0,0.0,2.002);
